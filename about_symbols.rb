...
class AboutSymbols < Neo::Koan
  ...
  # against the string value rather than against symbols? A: Performance?
  ...
  # A: difficult to keep track of naming/which symbols are available and names could change
end
